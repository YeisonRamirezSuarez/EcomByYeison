      ...
      <div className="relative z-10 flex items-center justify-between px-8 md:px-14 lg:px-20 py-12 md:py-10">
        ...
        <div className="space-y-5 max-w-md">
          ...
          <div className="flex items-center gap-3 pt-1">
            <Link
              href="/shop"
              className="inline-flex items-center gap-2 bg-shop_orange hover:bg-shop_orange/90 text-white px-6 py-3 rounded-xl font-semibold text-sm transition-all hover:scale-105 hover:shadow-lg hover:shadow-shop_orange/30 active:scale-95"
            >
              Comprar ahora
              <ArrowRight size={15} />
            </Link>
            <Link
              href="/deal"
              className="inline-flex items-center gap-2 border border-white/25 text-white/80 hover:text-white hover:border-white/50 hover:bg-white/10 px-6 py-3 rounded-xl font-semibold text-sm hoverEffect"
            >
              Ver ofertas
            </Link>
          </div>
